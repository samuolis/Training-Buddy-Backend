...
class EventController {
    ...
    fun signEventsForUsers(@PathVariable("userId") userId: String,
                           ...
                           @RequestHeader("authorization-code") authCode: String): Event{
    ...
    @RequestMapping(value = ["/events/signed/{userId}"], method = arrayOf(RequestMethod.POST))
    fun getUserSignedEvents(@PathVariable("userId") userId: String): List<Event> {
        return eventService.getEventsByEventIds(userId)
    }
